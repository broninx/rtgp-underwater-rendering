...
void LoadTextureCubeSide(string path, string side_image, GLuint side_name)
{
    ...
    stbi_set_flip_vertically_on_load(false); // do not flip the image loaded, because for the cube map we need a specific orientation of the images
...
GLint LoadTextureCube(string path)
{
    ...
    LoadTextureCubeSide(path, string("right.jpg"), GL_TEXTURE_CUBE_MAP_POSITIVE_X);
    LoadTextureCubeSide(path, string("left.jpg"), GL_TEXTURE_CUBE_MAP_NEGATIVE_X);
    LoadTextureCubeSide(path, string("top.jpg"), GL_TEXTURE_CUBE_MAP_POSITIVE_Y);
    LoadTextureCubeSide(path, string("bottom.jpg"), GL_TEXTURE_CUBE_MAP_NEGATIVE_Y);
    LoadTextureCubeSide(path, string("back.jpg"), GL_TEXTURE_CUBE_MAP_POSITIVE_Z);
    LoadTextureCubeSide(path, string("front.jpg"), GL_TEXTURE_CUBE_MAP_NEGATIVE_Z);
